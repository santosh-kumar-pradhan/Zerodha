    ...
    return (
        <>
            ...
            <LeftSection imageURL="\media\images\varsity.png"
                ...
                tryDemo="" learnMore="" googlePlay="" appStore=""
            />
             <p class='text-center text-muted fs-5 p-4'>Want to know more about our technology stack? Check out the <a href=""style={{textDecoration:"none"}}>Zerodha.tech </a> blog.</p>
            <Universe/>
        </>
    );
}
